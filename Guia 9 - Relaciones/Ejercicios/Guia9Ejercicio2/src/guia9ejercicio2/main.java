...
public class main {
     ...
     * el número del jugador), nombre (Empezara con Jugador más su ID, “Jugador
     * 1” por ejemplo) y mojado (indica si está mojado o no el jugador). El
     * número de jugadores será decidido por el usuario, pero debe ser entre 1 y
     * 6. Si no está en este rango, por defecto será 6. Métodos: •
     ...
     * guardarlos en los atributos del juego. 10 • ronda(): cada ronda consiste
     * en un jugador que se apunta con el revolver de agua y aprieta el gatillo.
     * Sí el revolver tira el agua el jugador se moja y se termina el juego,
     * sino se moja, se pasa al siguiente jugador hasta que uno se moje. Si o si
    ...
    public static void main(String[] args) {
        ...
        // Creo las variables de ArrayList de jugadores y Revolver donde voy a guardar las variables
        ArrayList<Jugador> jugadores = servJuego.llenarJugadores();
        Revolver revolver = servJuego.llenarRevolver();

        // Lleno el revolver
        servRevolver.llenarRevolver(revolver);

        // Empiezo el juego
        servJuego.ronda(jugadores, revolver, servJugador, servRevolver);
