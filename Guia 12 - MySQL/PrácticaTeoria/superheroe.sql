...
INSERT INTO personaje (id_personaje, nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) 
VALUES (7, 'Peter Parker', 'Spider Man', 165, '25 mil', 80, 74, 1962, 'Fotógrafo', 1);

INSERT INTO personaje (id_personaje, nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) 
VALUES (8, 'Steve Rogers', 'Capitan América', 145, '600 mil', 45, 60, 1941, 'Oficial federal', 1);

INSERT INTO personaje (id_personaje, nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) 
VALUES (9, 'Bobby Drake', 'Ice Man', 140, '2 mil', 64, 122, 1963, 'Contador', 1);

INSERT INTO personaje (id_personaje, nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) 
VALUES (10, 'Barry Allen', 'Flash', 160, '10 mil', 120, 168, 1956, 'Científico Forense', 1);

INSERT INTO personaje (id_personaje, nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) 
VALUES (11, 'Bruce Wayne', 'Batman', 170, '500 mil', 32, 47, 1939, 'Hombre de Negocios', 2);
...
/* SELECT para hacer una consulta, <*> para declarar que queremos marcar TODO de la tabla personaje*/
